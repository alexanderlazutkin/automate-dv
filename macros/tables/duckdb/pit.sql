...
{%- macro duckdb__pit(src_pk, src_extra_columns, as_of_dates_table, satellites, stage_tables_ldts, src_ldts, source_model) -%}
...
backfill AS (
    ...
    {%- for sat_name in satellites -%}
        ...
        COALESCE(UNHEX(MAX(HEX({{ sat_name | lower ~ '_src' }}.{{ sat_pk }}))),
